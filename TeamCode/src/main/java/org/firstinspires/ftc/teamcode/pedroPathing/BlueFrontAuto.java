...
@Autonomous(name = "BluefrontAuto", group = "Pedro Pathing")
public class BlueFrontAuto extends OpMode {
    ...
    // Start Pose
    private final Pose startPose = new Pose(60, 12, Math.toRadians(270));

    private final Pose intermPose = new Pose(60,72,Math.toRadians(270));
    // End Pose
